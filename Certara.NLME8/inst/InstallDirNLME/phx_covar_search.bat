...
rem echo  %INSTALLDIR%\\phx_covar_search.r COVAR_SEARCH %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %CONTROL_FILE% %NUM_PROCESSES% %WORKFLOW_NAME%
set tstart=%time%
Rscript  %INSTALLDIR%\\phx_covar_search.r COVAR_SEARCH %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %CONTROL_FILE% %NUM_PROCESSES% %WORKFLOW_NAME%
set tstop=%time%
