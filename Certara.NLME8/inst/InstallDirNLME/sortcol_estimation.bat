...
echo Rscript %INSTALLDIR%\\sortcol_estimation.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %CONTROL_FILE% %NUM_COLUMNS% %COLUMN_NAMES% %NUM_PROCESSES% %WORKFLOW_NAME%
set tstart=%time%
Rscript %INSTALLDIR%\\sortcol_estimation.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %CONTROL_FILE% %NUM_COLUMNS% %COLUMN_NAMES% %NUM_PROCESSES% %WORKFLOW_NAME%
set tstop=%time%
