...
echo  %INSTALLDIR%\\stepwise_covarsrch.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %MODEL_FILE% %ARGS_FILE% %FILES_TO_COPY% %NUM_COVARIATES% %COVARIATE_NAMES% %CRITERIA% %ADD_P_VALUE% %REMOVE_P_VALUE% %NUM_PROCESSES%  %WORKFLOW_NAME%

set tstart=%time%
Rscript %INSTALLDIR%\\stepwise_covarsrch.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %MODEL_FILE% %ARGS_FILE% %FILES_TO_COPY% %NUM_COVARIATES% %COVARIATE_NAMES% %CRITERIA% %ADD_P_VALUE% %REMOVE_P_VALUE% %NUM_PROCESSES% %WORKFLOW_NAME% 
set tstop=%time%
