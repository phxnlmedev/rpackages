...
echo Rscript  %INSTALLATION_DIRECTORY%\phx_bootstrap.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %METHOD% %ITERATIONS% %NUM_SAMPLES% %NUM_RETRIES% %MODEL_FILE% %COL_DEF_FILE% %DATA_FILE% %START_SEED%   %EXTRA_ARGS_FILE%   %FILES_TO_COPY% %NUM_PROCESSES% %CONFIDENCE_LEVEL% %WORKFLOW_NAME%

set tstart=%time%
Rscript  %INSTALLATION_DIRECTORY%\phx_bootstrap.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %METHOD% %ITERATIONS% %NUM_SAMPLES% %NUM_RETRIES% %MODEL_FILE% %COL_DEF_FILE% %DATA_FILE% %START_SEED%   %EXTRA_ARGS_FILE%   %FILES_TO_COPY% %NUM_PROCESSES% %CONFIDENCE_LEVEL% %WORKFLOW_NAME%
set tstop=%time%
