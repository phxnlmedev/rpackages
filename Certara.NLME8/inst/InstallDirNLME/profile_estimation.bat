...
rem echo Rscript %INSTALLDIR%\\profile_estimation.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %CONTROL_FILE% %NUM_COLUMNS% %COLUMN_NAMES% %PROFILE_SPECS% %PROFILE_FLAG% %NUM_PROCESSES% %WORKFLOW_NAME% 
set tstart=%time%
Rscript %INSTALLDIR%\\profile_estimation.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %CONTROL_FILE% %NUM_COLUMNS% %COLUMN_NAMES% %PROFILE_SPECS% %PROFILE_FLAG% %NUM_PROCESSES% %WORKFLOW_NAME%
set tstop=%time%
