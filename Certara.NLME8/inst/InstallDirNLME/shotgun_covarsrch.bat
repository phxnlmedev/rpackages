...
echo Rscript %INSTALLDIR%\\shotgun_covarsrch.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %MODEL_FILE% %ARGS_FILE% %FILES_TO_COPY% %NUM_COVARIATES% %COVARIATE_NAMES% %NUM_PROCESSES% %WORKFLOW_NAME% 
set tstart=%time%
Rscript %INSTALLDIR%\\shotgun_covarsrch.r %PARALLEL_MECHANISM% %INSTALLATION_DIRECTORY% %SHARED_DIRECTORY% %LOCAL_DIRECTORY% %MODEL_FILE% %ARGS_FILE% %FILES_TO_COPY% %NUM_COVARIATES% %COVARIATE_NAMES% %NUM_PROCESSES% %WORKFLOW_NAME% 
set tstop=%time%
