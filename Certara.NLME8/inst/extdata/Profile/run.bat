...
rem
rem  Command to run simple estimation
rem

echo %INSTALLDIR%\phx_profile_estimation.bat MULTICORE %INSTALLDIR% %shared_directory% %workDir% nlmeControlFile.txt 0 ""  "tvV,9.95482,-2,-1,0,1,2" USE_DELTA 4 SingleNlme  TRUE
%INSTALLDIR%\phx_profile_estimation.bat MULTICORE %INSTALLDIR% %shared_directory% %workDir% nlmeControlFile.txt 0 ""  "tvV,9.95482,-2,-1,0,1,2" USE_DELTA 4 SingleNlme  TRUE
