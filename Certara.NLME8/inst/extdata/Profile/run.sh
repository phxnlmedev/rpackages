...
# 
# Command to run profile estimation
#

${INSTALLDIR}/phx_profile_estimation.sh TORQUE_MPI ${INSTALLDIR} ${shared_directory} `pwd`  nlmeControlFile.txt 0 ""  tvV,9.95482,-2,-1,0,1,2 USE_DELTA 32 SingleNlme TRUE
